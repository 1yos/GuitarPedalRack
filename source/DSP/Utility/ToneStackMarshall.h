...
class ToneStackMarshall : public AudioModule
{
public:
    ToneStackMarshall();
    ~ToneStackMarshall() override;
    void prepare(double sampleRate, int samplesPerBlock) override;
    void reset() override;
    String getModuleType() const override { return "toneStackMarshall"; }
...
private:
    ...
    // Marshall tone stack coefficients
    float b0 = 1.0f, b1 = 0.0f, b2 = 0.0f, b3 = 0.0f;
    float a0 = 1.0f, a1 = 0.0f, a2 = 0.0f, a3 = 0.0f;
    
    void updateCoefficients();
    
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(ToneStackMarshall)
};
