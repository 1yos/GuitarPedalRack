...
LowPassFilter::LowPassFilter() : AudioModule("LowPassFilter") {}
...
void LowPassFilter::setFrequency(float frequency) { frequencyParam.store(frequency); }
void LowPassFilter::setResonance(float resonance) { resonanceParam.store(resonance); }
void LowPassFilter::setSlope(float slope) { slopeParam.store(slope); }

void LowPassFilter::processInternal(AudioBuffer<float>& buffer)
{
